...
|===============================================================================
| Definise se promjenljiva "userId", koja je dostupna svim metodama u ovoj klasi
|
*/
...
*/
	public static String[][] getReceivedMsg() 
	{
		...
		try {	
			...
			PreparedStatement msgReceiver = con.prepareStatement("SELECT *, DATE_FORMAT(date, '%d-%m-%Y %H:%i:%s') as dt "
					+ "FROM sms, user "
...
public static int countReceived(){
	...
	try {
		...
		PreparedStatement msgReceiver = con.prepareStatement("SELECT count(*) as ukupno FROM sms WHERE user_sender_id = ?");
...
public static int countSender(){
	...
	try {
		...
		PreparedStatement msgReceiver = con.prepareStatement("SELECT count(*) as ukupno FROM sms WHERE user_receiver_id = ?");
